...
('Testuser', 'Test User', 'test@test.com', '$2a$12$..2fdbMElI/dRr3G/JKhLOIKR.fmCIcBS.DJYDKAQ92ikq7QsDNee');
...
('Joe Pass Guitar Method', '978-0793521487', 'A comprehensive, easy-to-understand intermediate approach to jazz guitar playing techniques, helps develop an individual concept of improvising by learning scales and their basic chord forms and further develops improvisation skills through the use of practice patterns. Utilizes transcriptions along with several original pieces by Joe Pass.', 'guitar', 1981, 'Hal Leonard', 3),

('Intermediate Velocity Studies for Clarinet ', '978-0825833342', 'These studies by the master clarinetist, teacher, and craftsman, Kalmen Opperman, are the product of decades of experience. They have been in preparation for more than thirty-five years.', 'clarinet', 1999, 'Carl Fischer Music Publisher', 2),
